...
.DESCRIPTION
    Extract the complete list of all Disabled Users.
.EXAMPLE
    PS C:\adrt> .\ad-disabled.ps1
.NOTES
    Name: Thaigo Freitas
...
$result = @($disabled | Select -Property SamAccountName, Name)
...
$Subject = "[ Report-$mounth ] Active Directory - Disabled Users"
