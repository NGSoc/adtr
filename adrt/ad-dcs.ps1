...
.DESCRIPTION
    Extract the complete list of all Domain Controllers.
.EXAMPLE
    PS C:\adrt> .\ad-dcs.ps1
.NOTES
    Name: Thaigo Freitas
...
$Subject = "[ Report-$mounth ] Active Directory - Domain Controllers"
