...
.DESCRIPTION
    Extract the complete list of All GPOs.
.EXAMPLE
    PS C:\adrt> .\ad-gpos.ps1
.NOTES
    Name: Thaigo Freitas
...
#-- Filter
$gpos = @(Get-GPO -All | Select DisplayName, Owner, CreationTime, ModificationTime)
...
#-- Order by (A-Z)
$result = $result | Sort "DisplayName"
